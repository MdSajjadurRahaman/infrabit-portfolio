      ...
      <div className="container w-full mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center mb-4">
              <span className="text-2xl font-bold text-white">InfraBit</span>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {['Cloud Infrastructure', 'DevOps Automation', 'Security Solutions', 'Managed Services', 'Consulting'].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li className="flex">
                ...
                <span className="text-gray-400">info@infrabit.io</span>
              </li>
              <li className="flex">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; {currentYear} InfraBit. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
